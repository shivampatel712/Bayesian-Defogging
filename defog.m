function [final_albedo, final_depth] = defog(image, albedo_output, depth_output, outer_iters, inner_iters, final_airlight, albedo_prior_weight, depth_prior_weight, depth_prior_type, multi_scale, save_initial_depth, verbose)
    ...
    if multi_scale
        ...
        [final_albedo, final_depth] = factorize_multiscale(image, final_airlight,d ,0 , outer_iters, inner_iters, verbose, albedo_prior_weight, depth_prior_weight, depth_prior_type);
    end
    ...
    imwrite(albedo_output, final_albeo.*255);
    if verbose
